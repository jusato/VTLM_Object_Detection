...
#model_name = "ssd_resnet101_v1_fpn_shared_box_predictor_oid_v4_sync_2019_01_20"
model_name = "faster_rcnn_inception_resnet_v2_atrous_oid_v4_2018_12_12"
#model_name = "faster_rcnn_inception_resnet_v2_atrous_oid_v4_2018_12_12_ghconfig_reexport"
model_path = "/experiments/jsato/VTLM_object_detection/data/pretrained_models/" + model_name + "/saved_model"

labels_path = '/experiments/jsato/models/research/object_detection/data/oid_v4_label_map.pbtxt'
...
class Trainer(object):
    ...
    def mask_out_image(self, img_boxes, img_feats, img_labels):
        ...
        ##### Teste
        # Selecionar sample de imagens do batch para object detection 
        path_to_images = ['/data/jsato/raw_video_frames_v2/tr95_300h/0xmdaovBNms_3/000004.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/cOO2KZTmung_14/000004.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/a8QR93muFQ0_6/000002.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/_c6t_CPYwX4_13/000002.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/BoiglPDcW6E_12/000001.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/b3Tmri1D7HQ_9/000002.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/aVw1ECJzpuk_2/000001.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/e1A4CkU0X5A_3/000006.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/41zyDblyqf8_6/000005.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/1lmWJvzyngE_2/000003.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/DzcquJugexo_20/000001.jpg',
                          '/data/jsato/raw_video_frames_v2/tr95_300h/b__Gb4QGlBA_3/000001.jpg']
        images_ids = ['0xmdaovBNms_3', 'cOO2KZTmung_14', 'a8QR93muFQ0_6', '_c6t_CPYwX4_13', 'BoiglPDcW6E_12', 'b3Tmri1D7HQ_9', 
                      'aVw1ECJzpuk_2', 'e1A4CkU0X5A_3', '41zyDblyqf8_6', '1lmWJvzyngE_2', 'DzcquJugexo_20', 'b__Gb4QGlBA_3']

        for i in range(len(path_to_images)):
            st_time = time.time()
            image_np_with_detections = np.array(Image.open(path_to_images[i]))
            ...
            print(f'Time for 1 image: {tot_time:.7f}')

            img_boxes_np = detections['detection_boxes']
            img_labels_np = detections['detection_classes']
            img_scores_np = detections['detection_scores']

            vis_util.visualize_boxes_and_labels_on_image_array(
                  image_np_with_detections,
                  img_boxes_np[0].numpy(),
                  img_labels_np[0].numpy().astype(np.int32),
                  img_scores_np[0].numpy(),
                  category_index,
            ...
            #path_name = '/data/jsato/object_detection_masking/' + images_ids[i] + '.jpg'
            #plt.imsave(path_name, image_np_with_detections)

        total_time = time.time() - start_time
        print(f'This process took {total_time:.7f} seconds for 12/32 images')
