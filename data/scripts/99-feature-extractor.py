...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--img-root', default=f'',
    ...
    model_zenodo = tf.saved_model.load('/experiments/jsato/VTLM_en-pt/data/faster_rcnn_inception_resnet_v2_atrous_oid_v4_2018_12_12_ghconfig_reexport/saved_model').signatures['serving_default']

    model.structured_outputs['raw_detection_scores'] = model_zenodo.structured_outputs['raw_detection_scores']
    model.structured_outputs['detection_features'] = model_zenodo.structured_outputs['detection_features']
    model.structured_outputs['detection_multiclass_scores'] = model_zenodo.structured_outputs['detection_multiclass_scores']
    model.structured_outputs['raw_detection_boxes'] = model_zenodo.structured_outputs['raw_detection_boxes']
