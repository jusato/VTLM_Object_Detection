...
DATA_PATH="/experiments/jsato/VTLM_object_detection/data/how2"
FEAT_PATH="/experiments/jsato/VTLM_object_detection/data/how2/features"
DUMP_PATH="/experiments/jsato/VTLM_object_detection/models"
...
python3 /experiments/jsato/VTLM_object_detection/train.py --exp_name $EXP_NAME --dump_path $DUMP_PATH --data_path $DATA_PATH \
